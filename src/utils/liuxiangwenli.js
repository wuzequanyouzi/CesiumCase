...
Cesium.Material.PolylineTrailLinkImage = Cesium.buildModuleUrl('../assets/color.png');
// 定义着色器源码 核心部分
...
export default new PolylineTrailLinkMaterialProperty(Cesium.Color.BLUE, 8000);
export {
  Cesium
};